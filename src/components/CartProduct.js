...
export default function CartProduct({ image, title, price, color, description, itemType, material, id, handleDel, addToCart} ) {
  return (
          ...
          <Accordion defaultActiveKey="-1" flush>
            <Card>
              <Card.Header> 
                ...
                <button type="button" class="btn btn-danger btn-sm btn-block w-100" onClick={
                  () => {
                    handleDel(id);
                  }
